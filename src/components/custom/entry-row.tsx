...
import type { EntryDetailDrawerRef } from "@/components/custom/v2/entry-detail-drawer";
import { type TPopulatedEntry, toggleFullfilled } from "@/evolu-queries";
...
export function EntryRow({
	...
	detailDrawerRef: React.MutableRefObject<EntryDetailDrawerRef | null>;
	long?: boolean;
}): React.ReactElement {
		...
		>
			<div className="flex items-center gap-3 grow">
				...
				>
					...
					<span className="pr-6 flex flex-col text-right">
						<AmountDisplay
